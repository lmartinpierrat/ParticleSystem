...
namespace   ParticleSystem
{
    class   MinMaxValueFloat
    {
        ...
        public:
            ...
            MinMaxValueFloat(Type, const std::vector<std::pair<float, float> > &, const std::vector<std::pair<float, float> > & = std::vector<std::pair<float, float> >());
            ~MinMaxValueFloat(void);

            MinMaxValueFloat &operator=(const MinMaxValueFloat &);

        public:
            void                                            setFloat(float value) { this->_value1 = value; }
            void                                            setFloat1(float value) { this->_value1 = value; }
            void                                            setFloat2(float value) { this->_value2 = value; }
            void                                            setCurve(std::vector<std::pair<float, float> > &curve) { this->_curve1 = curve; }
            void                                            setCurve1(std::vector<std::pair<float, float> > &curve) { this->_curve1 = curve; }
            void                                            setCurve2(std::vector<std::pair<float, float> > &curve) { this->_curve2 = curve; }
